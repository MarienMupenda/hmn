<!DOCTYPE html>
<html>
<title>Publier un nouveau mariage</title>
...
<div class="w3-main w3-padding-large" style="margin-left:40%">
    ...
    <header class="w3-container w3-center" style="padding:128px 16px" id="home">
        <h1 class="w3-jumbo"><b>Nouveau Mariage</b></h1>
    ...
    <div class="w3-padding-32 w3-content w3-text-grey" id="contact" style="margin-bottom:64px">
        ...
        <?php echo form_open('nouveau'); ?>
        <p><select class="w3-input w3-padding-16 w3-border" type="text" placeholder="Sexe" required name="homme">
                <?php foreach ($hommes as $h): ?>
                    <option value="<?php echo $h['id']?>"><?php echo $h['nom']?></option>
                <?php endforeach; ?>
            </select></p>
        <p>
        <p><select class="w3-input w3-padding-16 w3-border" type="text" placeholder="Sexe" required name="femme">
